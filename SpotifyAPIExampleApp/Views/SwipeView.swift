...
struct SwipeView: View {
    ...
    func getRandomSearch() -> String {
            ...
            let randomCharacter = String(characters[characters.index(characters.startIndex, offsetBy: randomIndex)])
            var randomSearch = ""
        ...
        func search() {
            ...
            self.searchText = self.getRandomSearch()
            ...
            .sink(
                ...
                receiveValue: { searchResults in
                    ...
                    print("Name of song: \(self.tracks[0].name)")
                }
            )
        }
